...
// NOTE(tk) BrowserView is the one that handles updating logic.
@Component({
  components: { DeckTreeView , BrowserView, SpaceSeperatedInput },
  layout: 'fluid'
  ...
  onQueryStringUpdate () {
    ...
    this.$router.replace(`/?q=${encodeURIComponent(this.query)}`)
  }
